    ...
    for fish_elem in fish_prop.findall('./Property[@name="Fish"]'):
        try:
            ...
            fish = {
                ...
                'Name': name,
                'NameLower': product_details.get('NameLower'),
                'Group': group,
                'Description': description,
                'AltDescription': product_details.get('AltDescription'),
                'Hint': product_details.get('Hint'),
                'Quality': quality,
                'FishSize': fish_size,
                ...
                'Level': product_details.get('Level', 0),
                'ChargeValue': product_details.get('ChargeValue', 0),
                'MaxStackSize': product_details.get('MaxStackSize', 1),
                'DefaultCraftAmount': product_details.get('DefaultCraftAmount', 1),
                'CraftAmountStepSize': product_details.get('CraftAmountStepSize', 1),
                'CraftAmountMultiplier': product_details.get('CraftAmountMultiplier', 1),
                'Colour': product_details.get('Colour', 'FFFFFF'),
                'WorldColour': product_details.get('WorldColour'),
                'CookingValue': product_details.get('CookingValue', 0),
                'Usages': product_details.get('Usages', []),
                'BlueprintCost': product_details.get('BlueprintCost', 0),
                'BlueprintCostType': 'None',
                'BlueprintSource': 0,
                'RequiredItems': product_details.get('RequiredItems', []),
                'StatBonuses': [],
                'ConsumableRewardTexts': [],
                'HeroIconPath': product_details.get('HeroIconPath'),
                'PriceModifiers': product_details.get('PriceModifiers'),
                'SpecificChargeOnly': product_details.get('SpecificChargeOnly', False),
                'NormalisedValueOnWorld': product_details.get('NormalisedValueOnWorld', 0),
                'NormalisedValueOffWorld': product_details.get('NormalisedValueOffWorld', 0),
                'EconomyInfluenceMultiplier': product_details.get('EconomyInfluenceMultiplier', 0),
                ...
                'SubstanceCategory': product_details.get('SubstanceCategory'),
                'WikiCategory': product_details.get('WikiCategory'),
                'WikiEnabled': product_details.get('WikiEnabled', False),
                'FossilCategory': product_details.get('FossilCategory'),
                'CorvettePartCategory': product_details.get('CorvettePartCategory'),
                'CorvetteRewardFrequency': product_details.get('CorvetteRewardFrequency', 0),
                'Consumable': product_details.get('Consumable'),
                'CookingIngredient': product_details.get('CookingIngredient'),
                'GoodForSelling': product_details.get('GoodForSelling'),
                'EggModifierIngredient': product_details.get('EggModifierIngredient'),
                'DeploysInto': product_details.get('DeploysInto'),
                'BuildableShipTechID': product_details.get('BuildableShipTechID'),
                'GroupID': product_details.get('GroupID'),
                'PinObjective': product_details.get('PinObjective'),
                'PinObjectiveTip': product_details.get('PinObjectiveTip'),
                'PinObjectiveMessage': product_details.get('PinObjectiveMessage'),
                'PinObjectiveScannableType': product_details.get('PinObjectiveScannableType'),
                'PinObjectiveEasyToRefine': product_details.get('PinObjectiveEasyToRefine', False),
                'NeverPinnable': product_details.get('NeverPinnable', False),
                'GiveRewardOnSpecialPurchase': product_details.get('GiveRewardOnSpecialPurchase'),
                'FoodBonusStat': product_details.get('FoodBonusStat'),
                'FoodBonusStatAmount': product_details.get('FoodBonusStatAmount', 0),
                'IsTechbox': product_details.get('IsTechbox', False),
                'CanSendToOtherPlayers': product_details.get('CanSendToOtherPlayers', True),
            }
