    ...
    for item_elem in table_prop.findall('./Property[@name="Table"]'):
        try:
            ...
            cooking = {
                ...
                'NameLower': product_info.get('NameLower'),
                'Group': product_info['Group'],
                'Description': product_info['Description'],
                'AltDescription': product_info.get('AltDescription'),
                'Hint': product_info.get('Hint'),
                'BaseValueUnits': product_info['BaseValueUnits'],
                'CurrencyType': 'Credits',
                'Level': product_info.get('Level', 0),
                'ChargeValue': product_info.get('ChargeValue', 0),
                'MaxStackSize': product_info['MaxStackSize'],
                'DefaultCraftAmount': product_info.get('DefaultCraftAmount', 1),
                'CraftAmountStepSize': product_info.get('CraftAmountStepSize', 1),
                'CraftAmountMultiplier': product_info.get('CraftAmountMultiplier', 1),
                'Colour': product_info['Colour'],
                'WorldColour': product_info.get('WorldColour'),
                ...
                'HeroIconPath': product_info.get('HeroIconPath'),
                'PriceModifiers': product_info.get('PriceModifiers'),
                'SpecificChargeOnly': product_info.get('SpecificChargeOnly', False),
                'NormalisedValueOnWorld': product_info.get('NormalisedValueOnWorld', 0),
                'NormalisedValueOffWorld': product_info.get('NormalisedValueOffWorld', 0),
                'EconomyInfluenceMultiplier': product_info.get('EconomyInfluenceMultiplier', 0),
                'Rarity': product_info.get('Rarity'),
                'Legality': product_info.get('Legality'),
                'TradeCategory': product_info.get('TradeCategory'),
                'ProductCategory': product_info.get('ProductCategory'),
                'SubstanceCategory': product_info.get('SubstanceCategory'),
                'WikiCategory': product_info.get('WikiCategory'),
                'WikiEnabled': product_info.get('WikiEnabled', False),
                'FossilCategory': product_info.get('FossilCategory'),
                'CorvettePartCategory': product_info.get('CorvettePartCategory'),
                'CorvetteRewardFrequency': product_info.get('CorvetteRewardFrequency', 0),
                ...
                'BuildableShipTechID': product_info.get('BuildableShipTechID'),
                'GroupID': product_info.get('GroupID'),
                'PinObjective': product_info.get('PinObjective'),
                'PinObjectiveTip': product_info.get('PinObjectiveTip'),
                'PinObjectiveMessage': product_info.get('PinObjectiveMessage'),
                'PinObjectiveScannableType': product_info.get('PinObjectiveScannableType'),
                'PinObjectiveEasyToRefine': product_info.get('PinObjectiveEasyToRefine', False),
                'NeverPinnable': product_info.get('NeverPinnable', False),
                'GiveRewardOnSpecialPurchase': product_info.get('GiveRewardOnSpecialPurchase'),
                'FoodBonusStat': product_info.get('FoodBonusStat'),
                'FoodBonusStatAmount': product_info.get('FoodBonusStatAmount', 0),
                'IsTechbox': product_info.get('IsTechbox', False),
                'CanSendToOtherPlayers': product_info.get('CanSendToOtherPlayers', True),
